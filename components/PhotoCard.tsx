  ...
  return (
    ...
    >
      ...
      <div className="paper-texture p-2 pb-6 shadow-lg transition-shadow duration-300 hover:shadow-2xl w-[180px] md:w-[200px] lg:w-[220px]">
        ...
        <div className="text-center px-1" onClick={() => onView(memory)}>
          {/* Reduced font sizes */}
          <h3 className="font-display text-lg text-gray-800 dark:text-gray-100 leading-tight mb-1 truncate cursor-pointer hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">{memory.title}</h3>
